...
(a) For each of the Bell States, produces the circuit that yields the state starting from the \(|00\rangle\) state (2 qubits all initially in the zero states). You can either build each circuit in Qiskit and plot it using the draw command in Qiskit:
\\
